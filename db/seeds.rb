...
Topic.create(name: 'time management')
...
Question.create(title: 'COOKIE??!!??', body: 'Does anybody know any good cookie places near Seasame St?', topic_id: '2', author_id: '2')
Question.create(title: 'What day is it?', body: 'I lost my calender, what day of the week is it?', topic_id: '3', author_id: '3')
Question.create(title: 'Tortilla substitutions?', body: 'I\'m out of tortillas, what could I replace them with in my kitchen?', topic_id: '4', author_id: '3')
